            ...
            {filteredSubjectCards.map((sub, idx) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-3xl border border-slate-200 hover:border-blue-300 transition-all duration-200 hover:shadow-md cursor-pointer flex flex-col justify-between overflow-hidden group"
                >
                  <div className="p-5 space-y-3.5">
                    {/* Header: Mapel Code, Rank, and Category */}
                    <div className="flex items-center gap-2">

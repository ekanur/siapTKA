    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 sm:gap-6">
            ...
            <div className="hidden sm:flex items-center gap-2 text-xs font-semibold text-slate-500 border-l border-slate-200 pl-4">
              <span>SMKN 2 Depok Sleman</span>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-10 space-y-6 flex-1 w-full">
        ...
        {alreadyConfirmed && timeline.isWithinPeriod && (
          <div className="p-4 rounded-2xl bg-blue-50 border border-blue-200 text-blue-900 text-xs flex items-start gap-3 shadow-xs">
